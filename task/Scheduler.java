...
{
	static final String HTML_TEXT = "<html><div style='font-family: Tahoma, Geneva, sans-serif; text-align: left; font-size: 14px;'>";
	...
	public static void setConfigGUIForWin()
	{
		...
		modField.setFont(new Font("Tahoma", Font.PLAIN, 14));
			...
			radBtns[i].addActionListener(new ActionListener() {
			    ...
			    public void actionPerformed(ActionEvent e) {
			        ...
			        if (schedID==2 || schedID==3) 
			        {
			        	...
			        	weekDayField.setFont(new Font("Tahoma", Font.PLAIN, 14));
		...
		for (int i=0; i<START_TIME_MAX.length; i++)
		{
			...
			startTimeFields[i].setFont(new Font("Tahoma", Font.PLAIN, 14));
	...
	public static void setConfigGUIForUnix()
	{
		...
		configBtn.setToolTipText(HTML_TEXT+
		"For validation purposes, if the units have higher values than<br>"
		+"normal, they will be set to their respective maximum values.");
		...
		for (int i=0; i<units.length; i++)
		{
			...
			units[i].setFont(new Font("Tahoma", Font.PLAIN, 14));
		...
		for (int i=0; i<4; i++)
		{
			...
			radioBtns[i].addActionListener(new ActionListener()
			{
				...
				{
					schedID = constant;
					nUnit.setFont(new Font("Tahoma", Font.PLAIN, 14));
